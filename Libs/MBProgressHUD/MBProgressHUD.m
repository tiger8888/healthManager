...
//added by liyatu
+ (MBProgressHUD *)showCustomHUDAddedTo:(UIView *)view animated:(BOOL)animated delayTime:(NSTimeInterval)delayTime title:(NSString*)title success:(BOOL)success completionBlock:(CompletionBlock)completionBlock
{
	MBProgressHUD *hud = [[MBProgressHUD alloc] initWithView:view];
    NSString* imagePath = success? @"checkmark":@"checkmark";
...
//added by liyatu
+ (MBProgressHUD *)showLabelHUDAddedTo:(UIView *)view animated:(BOOL)animated delayTime:(NSTimeInterval)delayTime title:(NSString*)title
{
	MBProgressHUD *hud = [[MBProgressHUD alloc] initWithView:view];
...
- (void)hide:(BOOL)animated {
	...
	if (self && self.minShowTime > 0.0 && showStarted) {
